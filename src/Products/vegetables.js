      ...
      <div style={{ backgroundColor: "#FFFFE8" }}>
        ...
        <div className="bg-image" style={{marginLeft:"20px",marginRight:"20px",borderRadius:"10px"}}>
          ...
          >
            <div className="d-flex justify-content-center align-items-center h-100">
              <p className="text-white mb-0">Vegetables</p>
            </div>
          </div>
        </div>
        <br />
        <MDBCard className="mx-auto" style={{ width:"70%",height: "auto",maxHeight:"600px" }}>
          ...
          <MDBCardBody className="text-center">
            <MDBCardTitle>Onion</MDBCardTitle>
            <MDBCardText>
        ...
        <MDBCard className="mx-auto" style={{ width:"70%",height: "auto",maxHeight:"600px" }}>
          ...
          <MDBCardBody className="text-center">
            <MDBCardTitle>Green Chilli</MDBCardTitle>
            <MDBCardText>
              Some quick example text to build on the card title and make up the
              bulk of the card's content.
            </MDBCardText>
        ...
        <br />
        <MDBCard className="mx-auto" style={{ width:"70%",height: "auto",maxHeight:"500px" }}>
          <MDBRipple
            rippleColor="light"
            rippleTag="div"
            className="bg-image hover-overlay"
          ...
          <MDBCardBody className="text-center">
            <MDBCardTitle>Drumstick</MDBCardTitle>
            <MDBCardText>
              Some quick example text to build on the card title and make up the
              bulk of the card's content.
            </MDBCardText>
